...
definition(
    ...
    description: "Checks to see whether your sump pump is running more than usual. Connect a multi-sensor to the sump pum
p outlet pipe and it will alert you if it detects vibration more than twice in X amount of minutes.",
    category: "My Apps",
